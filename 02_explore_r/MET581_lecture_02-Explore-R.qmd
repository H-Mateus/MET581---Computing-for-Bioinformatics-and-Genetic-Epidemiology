...
1.    Use the base R function `read.table()` to import the [pheno.txt](https://h-mateus.github.io/MET581---Computing-for-Bioinformatics-and-Genetic-Epidemiology/data/pheno.txt) file. Then repeat this with `read_tsv()` from Readr, what is the difference? 
