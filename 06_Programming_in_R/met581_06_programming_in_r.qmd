...
> The implementation of logic to facilitate specified computing operations and functionality {.center}
...
-   This is [**bad programming!**]{style="color:#cc0000"} X because it means you have to remember the command and each of its arguments (try doing that for 1000 functions!).
